  ...
  return (
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          src="https://cdn.poehali.dev/projects/69fa64a6-b117-4b02-9e2b-021f13758da1/bucket/3a9a14ac-a490-49fc-ba92-ad8e881e4984.jpg"
          alt="Спутниковый мониторинг транспорта"
      ...
      >
        <div className="mb-72 md:mb-60 lg:mb-80">
          <p className="text-sm tracking-[0.3em] uppercase text-center text-secondary mb-0">{"Спутниковый мониторинг"}</p>
          ...
          >
            {"Контроль транспорта"}
            <br />
            <span className="text-orange-200">{"и полей"}</span>
          </h1>
        </div>
      </div>
